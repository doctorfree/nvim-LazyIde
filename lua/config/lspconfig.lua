...
if table_contains(mason_servers, "jsonls") then
...
if table_contains(mason_servers, "eslint") then
...
if table_contains(mason_servers, "tsserver") then
  ...
  -- Original tsserver setup was in lspconfig opts:
  --  tsserver = {
...
for _, server in ipairs(check_servers_with_navic) do
  if table_contains(mason_servers, server) then
...
if table_contains(mason_servers, "yamlls") then
...
if table_contains(mason_servers, "lua_ls") then
...
-- Original lspconfig loading code
-- load lsp config
